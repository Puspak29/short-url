            ...
            <td className="px-8 py-5">
              <div className="flex flex-col">
                <div className="flex items-center gap-2">
                  <span
                    className={`text-sm font-black cursor-pointer hover:underline transition-colors ${link.isActive === false ? 'text-zinc-700 line-through' : 'text-emerald-500'}`}
        ...
        >
          ...
          <div className="flex items-start justify-between gap-2 mb-3">
            <div className="flex flex-col min-w-0">
              <div className="flex items-center gap-2">
                <span
                  className={`text-sm font-black cursor-pointer hover:underline transition-colors break-all ${link.isActive === false ? 'text-zinc-700 line-through' : 'text-emerald-500'}`}
                  onClick={() => onView(link)}
                >
                  {DOMAIN}/{link.shortUrl}
                </span>
