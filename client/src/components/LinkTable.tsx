import { BarChart3, Copy, Lock, Power, PowerOff, Trash2 } from "lucide-react";
        ...
        <tr key={link.id} className={`group hover:bg-emerald-500/5 transition-all ${link.status === 'inactive' ? 'opacity-40 bg-zinc-950/30' : ''}`}>
          <td className="px-8 py-5">
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-zinc-600 font-mono truncate max-w-50">{link.original}</span>
            </div>
          </td>
          <td className="px-8 py-5">
            <div className="flex items-center gap-2">
